...
// ../../node_modules/.pnpm/@prisma+engines-version@4.13.0-50.1e7af066ee9cb95cf3a403c78d9aab3e6b04f37a/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@4.13.0-50.1e7af066ee9cb95cf3a403c78d9aab3e6b04f37a/node_modules/@prisma/engines-version/package.json"(exports, module2) {
    module2.exports = {
      ...
      prisma: {
        enginesVersion: "1e7af066ee9cb95cf3a403c78d9aab3e6b04f37a"
      },
      repository: {
        type: "git",
...
// ../../node_modules/.pnpm/@prisma+engines-version@4.13.0-50.1e7af066ee9cb95cf3a403c78d9aab3e6b04f37a/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@4.13.0-50.1e7af066ee9cb95cf3a403c78d9aab3e6b04f37a/node_modules/@prisma/engines-version/index.js"(exports) {
    "use strict";
...
var require_async = __commonJS({
  "../../node_modules/.pnpm/resolve@1.22.1/node_modules/resolve/lib/async.js"(exports, module2) {
    ...
    var defaultReadPackage = /* @__PURE__ */ __name(function defaultReadPackage2(readFile4, pkgfile, cb) {
...
var require_graceful_fs = __commonJS({
  "../../node_modules/.pnpm/graceful-fs@4.2.10/node_modules/graceful-fs/graceful-fs.js"(exports, module2) {
    ...
    function patch(fs12) {
      ...
      function readFile4(path9, options2, cb) {
        if (typeof options2 === "function")
...
var readFile2 = (0, import_util5.promisify)(import_fs7.default.readFile);
var writeFile = (0, import_util5.promisify)(import_fs7.default.writeFile);
...
function buildDirnameFind(defaultRelativeOutdir) {
...
var readFile3 = import_fs8.default.promises.readFile;
async function buildInlineSchema(dataProxy2, schemaPath2) {
  if (dataProxy2 === true) {
    const b64Schema = (await readFile3(schemaPath2)).toString("base64");
...
// src/generation/generateClient.ts
var remove = (0, import_util6.promisify)(import_fs9.default.unlink);
var writeFile2 = (0, import_util6.promisify)(import_fs9.default.writeFile);
var exists3 = (0, import_util6.promisify)(import_fs9.default.exists);
var copyFile = (0, import_util6.promisify)(import_fs9.default.copyFile);
var stat = (0, import_util6.promisify)(import_fs9.default.stat);
...
async function getDefaultOutdir(outputDir2) {
  ...
  if (process.env.INIT_CWD && process.env.npm_lifecycle_event === "postinstall" && !process.env.PWD?.includes(".pnpm")) {
    if (import_fs9.default.existsSync(import_path8.default.join(process.env.INIT_CWD, "package.json"))) {
...
async function verifyOutputDirectory(directory, datamodel2, schemaPath2) {
  let content;
  try {
    content = await import_fs9.default.promises.readFile(import_path8.default.join(directory, "package.json"), "utf8");
  } catch (e2) {
    if (e2.code === "ENOENT") {
      return;
    }
